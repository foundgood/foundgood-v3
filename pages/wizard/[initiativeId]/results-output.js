...
import ResultsOutput from 'components/_wizard/_cards/_cardContents/resultsOutput';
...
const ResultsOutputComponent = () => {
    ...
    function getItemData(formData) {
        ...
        // Data for sf
        return {
            Type__c: CONSTANTS.RESULTS.CUSTOM_OUTPUT,
            Name,
            Description__c,
    ...
    // Get results
    const results = utilities.results.getTypeCustomOutput();
            ...
            <Collection
                {...{
                    collection: {
                        items: results,
                        fields: itemFields,
                        addLabel: label('ButtonAddResultsOutput'),
                        emptyLabel: label('EmptyStateWizardPageResultsOutput'),
                    },
                    methods: {
                        add: {
                            title: label('WizardModalHeadingResultsOutput'),
                            action: addItem,
                        },
                        edit: {
                            title: label('WizardModalHeadingResultsOutput'),
                        ...
                        delete: {
                            title: label(
                                'WizardModalHeadingResultsOutputDelete'
                            ),
                            text: label('WizardModalTextResultsOutputDelete'),
                            action: deleteItem,
                        },
                    },
                    card: {
                        ...
                        type() {
                            return label('CardTypeResultsOutput');
                        },
                        components(item) {
                            return {
                                cardContent: <ResultsOutput {...{ item }} />,
                                relatedItems: (
...
ResultsOutputComponent.layout = 'wizard';

export default WithAuth(ResultsOutputComponent);
