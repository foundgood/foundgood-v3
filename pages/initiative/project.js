...
const ProjectComponent = ({ pageProps }) => {
    ...
    useEffect(() => {
        ...
        // https:github.com/react-static/react-static/issues/144
    ...
    return (
        <>
            ...
            {/* Overview */}
            <div className="p-20 mt-48 bg-white rounded-8">
                ...
                <div className="mt-24">
                    ...
                    <div className="flex flex-col lg:mt-32">
                        ...
                        <div className="flex justify-between p-16 mb-20 border-4 border-gray-10 rounded-8">
                            <div>
            ...
            <div className="pb-48">
                            ...
                            {initiativeData?._employeesFunded?.length &&
                                initiativeData?._employeesFunded?.map(
                                    (item, index) => (
                                        <div
                                            key={`e-${index}`}
                                            className="flex pt-16 pb-16 border-b-2 border-amber-10">
                                            <div className="w-full t-h6">
                                                {item.Job_Title__c}
                                            </div>
                                            <div className="w-full">
                ...
                {initiativeData?.Ultimate_Outcome__c && (
                    <SectionWrapper className="mt-32 bg-white rounded-8">
                        <div className="flex justify-between">
                            <h2 className="t-h3">{labelTodo('Our vision')}</h2>
                            <Button variant="secondary">
                                {labelTodo('Update')}
                            </Button>
                        </div>
